...
namespace OpenLoco::StringIds
{
    ...
    constexpr string_id keyboard_backspace = 748;
    constexpr string_id keyboard_tab = 749;
    constexpr string_id keyboard_return = 753;
    constexpr string_id keyboard_alt_menu = 758;
    constexpr string_id keyboard_pause = 759;
    constexpr string_id keyboard_caps = 760;
    constexpr string_id keyboard_escape = 767;
    constexpr string_id keyboard_spacebar = 772;
    constexpr string_id keyboard_pageup = 773;
    constexpr string_id keyboard_pagedown = 774;
    constexpr string_id keyboard_end = 775;
    constexpr string_id keyboard_home = 776;
    constexpr string_id keyboard_left = 777;
    constexpr string_id keyboard_up = 778;
    constexpr string_id keyboard_right = 779;
    constexpr string_id keyboard_down = 780;
    constexpr string_id keyboard_insert = 785;
    constexpr string_id keyboard_delete = 786;
    constexpr string_id keyboard_numpad_0 = 836;
    constexpr string_id keyboard_numpad_1 = 837;
    constexpr string_id keyboard_numpad_2 = 838;
    constexpr string_id keyboard_numpad_3 = 839;
    constexpr string_id keyboard_numpad_4 = 840;
    constexpr string_id keyboard_numpad_5 = 841;
    constexpr string_id keyboard_numpad_6 = 842;
    constexpr string_id keyboard_numpad_7 = 843;
    constexpr string_id keyboard_numpad_8 = 844;
    ...
    constexpr string_id keyboard_numlock = 884;
    constexpr string_id keyboard_scroll = 885;
    ...
    constexpr string_id deleteAllOrders = 2275;

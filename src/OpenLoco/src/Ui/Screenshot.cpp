...
namespace OpenLoco::Ui
{
    ...
    static Ui::Viewport createGiantViewport(const uint16_t resolutionWidth, const uint16_t resolutionHeight, const uint8_t zoomLevel)
    {
        ...
        const coord_t centreX = (World::TileManager::kMapColumns / 2) * 32 + 16;
        const coord_t centreY = (World::TileManager::kMapRows / 2) * 32 + 16;
    ...
    static std::string saveGiantScreenshot()
    {
        ...
        const uint16_t resolutionWidth = ((World::TileManager::kMapColumns * 32 * 2) >> zoomLevel) + 8;
        const uint16_t resolutionHeight = ((World::TileManager::kMapRows * 32 * 1) >> zoomLevel) + 128;
